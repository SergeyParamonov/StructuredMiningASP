...
def main():
    ...
    clasp_jmlr = clasp_jmlr[clasp_jmlr['pattern_type'] == "closed"]
    clasp_iprg      = clasp_iprg[clasp_iprg['pattern_type'] == "closed"]

    wasp_jmlr = wasp_jmlr[wasp_jmlr['pattern_type'] == "closed"]
    wasp_iprg      = wasp_iprg[wasp_iprg['pattern_type'] == "closed"]
