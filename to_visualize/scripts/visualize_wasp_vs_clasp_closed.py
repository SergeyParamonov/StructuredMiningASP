...
def main():
    ...
    clasp_mushrooms = clasp_mushrooms[clasp_mushrooms['pattern_type'] == "closed"]
    clasp_vote      = clasp_vote[clasp_vote['pattern_type'] == "closed"]

    wasp_mushrooms = wasp_mushrooms[wasp_mushrooms['pattern_type'] == "closed"]
    wasp_vote      = wasp_vote[wasp_vote['pattern_type'] == "closed"]
